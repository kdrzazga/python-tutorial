...
class RobinTest:
    def __init__(self, width=900, height=700):
        ...
        pygame.display.set_caption("Christmas Robin Test")
        self._init_gl()
    ...
    def _create_robins(self):
        placements = ((-1.15, 0.85, 0.0, 1), (0.0, 1.1, 0.5, 2), (1.15, 0.85, 1.0, 3))
        robins = []
        for x, size, hue, seed in placements:
            robins.append(ChristmasRobin(x, 0.0, 0.0, size=size, hue=hue, head_bob=True, seed=seed))
        return robins
    ...
    def run(self):
        ...
        while running:
            ...
            gluLookAt(math.sin(orbit) * 3.6, 1.4, math.cos(orbit) * 3.6, 0.0, 0.55, 0.0, 0.0, 1.0, 0.0)
