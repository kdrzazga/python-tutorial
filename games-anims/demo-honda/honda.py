...
class Demo:
    ...
    def __init__(self):
        ...
        self.WIDTH, self.HEIGHT = 496, 800
        ...
        punch_bitmap = pygame.image.load("resources/honda_punch.png").convert_alpha()
        ...
        self.stand_sequence = deque((honda1_bitmap, honda2_bitmap,honda1_bitmap, honda2_bitmap, honda1_bitmap,honda1_bitmap, honda2_bitmap,honda1_bitmap, honda2_bitmap, honda1_bitmap, honda3_bitmap))
        self.walk_sequence = deque(( step1_bitmap, honda1_bitmap, step2_bitmap))
        self.punch_sequence = deque((honda1_bitmap, punch_bitmap, honda2_bitmap, punch_bitmap ))
    ...
    def phase1(self):
        ...
        while y <= self.y_max:
            ...
            y += 1
            self.screen.blit(self.jump_bitmap, (0, y))
