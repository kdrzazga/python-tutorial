...
def get_next_color():
    available_colors = (Globals.GREEN, Globals.WHITE, Globals.CYAN, Globals.RED, Globals.YELLOW, (34, 177, 76), Globals.PURPLE, Globals.BROWN)
...
while running:
    ...
    random_tile = tiles[random_tile_index]
    if len(tiles) > 1:
